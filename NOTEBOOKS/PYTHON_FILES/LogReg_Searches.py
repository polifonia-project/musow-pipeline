...
class LogRegSearches(object):
    ...
    def train(t_input, t_feature, target, cv_int, score_type, max_feats, stopwords, filename, path):
        return lr_training(t_input, t_feature, target, cv_int, score_type, max_feats, stopwords, filename, path)
